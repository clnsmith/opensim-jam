...
copy ..\install\plugin\jam_plugin.dll opensim-jam-release\bin\win
copy ..\install\cmd_tools\comak.exe opensim-jam-release\bin\win
copy ..\install\cmd_tools\comak-inverse-kinematics.exe opensim-jam-release\bin\win
copy ..\install\cmd_tools\forsim.exe opensim-jam-release\bin\win
copy ..\install\cmd_tools\joint-mechanics.exe opensim-jam-release\bin\win
