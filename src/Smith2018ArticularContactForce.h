...
interpenetrate and the proximity (distance between the meshes) is calculated for
each triangle. For each triangle with a positive proximity (ie triangle 
interpenetrated the opposing mesh), the contact pressure on each triangle face 
