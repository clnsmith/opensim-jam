...
public:
    ...
    const SimTK::Vector_<SimTK::Vec3>& Smith2018ContactMesh::
        getTriangleCenters() const {
        return _tri_center;}

    const SimTK::Vector_<SimTK::UnitVec3>& Smith2018ContactMesh::
        getTriangleNormals() const {
        return _tri_normal;}

    const SimTK::Matrix_<SimTK::Vec3>& Smith2018ContactMesh::
        getFaceVertexLocations() const {
        return _face_vertex_locations;}

    const SimTK::Vector_<SimTK::Vec3>& Smith2018ContactMesh::
        getVertexLocations() const {
